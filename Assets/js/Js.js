...
function finalVideo() {
    //Video ends, iconschange
    videoIcon.classList.remove('uil-pause')
    videoIcon.classList.add('uil-play')
}
    //Ended when te hvideo ends
...
sr.reveal(`.home__data, .home__social-link, .home__info, .discover__container, .expererience__data, .experience__overlay, .place__card, .sponsor__content, .footer__data, .footer__rights`, {
    origin: 'top',
    interval: 100,
})
